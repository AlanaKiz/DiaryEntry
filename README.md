...
- 🔄 Automatically loads saved entries  
- 🗑️ Clear / delete entry for a selected date  
- 🎨 Clean blue-themed user interface  
...
- Clicking **Save Entry** stores the entry under the selected date.
- Entries are saved in the browser using `localStorage`.
